  ...
  <div class="home-container">
    ...
    <div class="content-wrapper">
      <el-row :gutter="40" class="section-row">
        <el-col :span="14">
          <div class="section-title">
            <h2>今日时政</h2>
            <span class="more" @click="$router.push('/portal/news')"
              >查看更多 ></span
            >
          </div>
            ...
            >
              <div class="news-info">
                ...
                <div class="news-meta">
                  <span
                    >📅
                    {{ new Date(news.created_at).toLocaleDateString() }}</span
                  >
                  <span style="margin-left: 10px"
                    >👤 {{ news.author_name || "管理员" }}</span
                  >
                </div>
              </div>
            </div>
        ...
        <el-col :span="10">
          <div class="section-title">
            <h2>学习园地</h2>
            <span class="more" @click="$router.push('/portal/learning')"
              >查看更多 ></span
            >
          </div>
      ...
      <div class="section-row">
        <div class="section-title">
          <h2>党员风采</h2>
          <span class="more" @click="$router.push('/portal/showcase')"
            >查看更多 ></span
          >
        </div>
        <!-- 党员风采渲染区域 -->
      ...
      <div class="section-row">
        <div class="section-title">
          <h2>实践中心</h2>
          <span class="more" @click="$router.push('/portal/practice')"
            >查看更多 ></span
          >
        </div>
        <!-- 实践中心渲染区域 -->
...
.banner-overlay {
  ...
  align-items: center;
  background: rgba(0, 0, 0, 0.4); /* 半透明黑色遮罩，让白色文字更清晰 */
  color: white;
